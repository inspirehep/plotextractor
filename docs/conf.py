...
release = get_current_version(project_dir='..')
...
htmlhelp_basename = 'plotextractor_namedoc'
...
man_pages = [
    (master_doc, 'plotextractor', u'plotextractor Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'plotextractor', u'plotextractor Documentation',
   author, 'plotextractor', 'Small library for extracting plots used in scholarly communication.',
   'Miscellaneous'),
]
